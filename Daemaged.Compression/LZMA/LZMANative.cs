...
{  
  internal class LZMANative
  {
    ...
    public static extern unsafe LZMAStatus lzma_auto_decoder(void* strm, ulong memlimit, uint flags);
    ...
    //
    [DllImport(LZMA, CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe LZMAStatus lzma_code(void* strm, LZMAAction action);
    ...
    [DllImport(LZMA, CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe LZMAStatus lzma_alone_encoder(void* strm, ref LZMAOptionLZMA options);

    [DllImport(LZMA, CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe LZMAStatus lzma_easy_encoder(void* strm, uint preset, LZMACheck check);
    ...
    //              - LZMA_PROG_ERROR
    [DllImport(LZMA, CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe LZMAStatus lzma_stream_encoder(void* strm, void* filters,
                                                               LZMACheck check);
    ...
    [DllImport(LZMA, CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe ulong lzma_memusage(void* strm);
    ...
    //
    [DllImport(LZMA, CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe ulong lzma_memlimit_get(void* strm);
    ...
    [DllImport(LZMA, CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe LZMAStatus lzma_memlimit_set(void* strm, ulong memlimit);
 ...
 */
  ...
  public unsafe class LZMAOptionLZMA
  {
    public LZMAOptionLZMA(uint preset)
    {
      ...
      //if (preset == 9) preset = (preset | LZMANative.LZMA_PRESET_EXTREME);
      LZMANative.lzma_lzma_preset(h.AddrOfPinnedObject().ToPointer(), preset);
    }
